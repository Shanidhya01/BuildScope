      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-300 text-sm">
            Sign in to continue to BuildScope
          </p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="email"
                  required
                  className="block w-full pl-10 pr-3 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none text-slate-900 placeholder:text-slate-400 bg-white"
